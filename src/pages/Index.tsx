        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link to="/login">
                <Button variant="outline" size="sm" className="border-primary-yellow text-primary-yellow hover:bg-primary-yellow hover:text-black">
                  Login
                </Button>
              </Link>
            </div>
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/login">
              <Button size="lg" className="bg-primary-yellow text-black hover:bg-primary-yellow/90 transition-all duration-300 transform hover:scale-105">
                Get Started
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Button variant="outline" size="lg" className="border-primary-yellow text-primary-yellow hover:bg-primary-yellow hover:text-black">
              Watch Demo
            </Button>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border-primary-yellow/20 bg-card-black/50 backdrop-blur-sm">
            <CardHeader className="text-center">
              <CardTitle className="text-3xl mb-2 text-white">Demo Accounts</CardTitle>
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center p-4 rounded-lg border border-primary-yellow/20 bg-primary-yellow/5">
                  ...
                  <p className="text-sm text-white/80 mb-3">Order snacks from your seat</p>
                  <code className="text-xs bg-card-black p-2 rounded block mb-1 text-primary-yellow">customer@demo.com</code>
                  <code className="text-xs bg-card-black p-2 rounded block text-primary-yellow">password123</code>
                </div>
                <div className="text-center p-4 rounded-lg border border-primary-yellow/20 bg-primary-yellow/5">
                  <Users className="h-8 w-8 text-primary-yellow mx-auto mb-3" />
                  <h3 className="font-semibold mb-2 text-white">Staff</h3>
                  <p className="text-sm text-white/80 mb-3">Manage orders and deliveries</p>
                  <code className="text-xs bg-card-black p-2 rounded block mb-1 text-primary-yellow">staff@demo.com</code>
                  <code className="text-xs bg-card-black p-2 rounded block text-primary-yellow">password123</code>
                </div>
                <div className="text-center p-4 rounded-lg border border-primary-yellow/20 bg-primary-yellow/5">
                  <Users className="h-8 w-8 text-primary-yellow mx-auto mb-3" />
                  <h3 className="font-semibold mb-2 text-white">Admin</h3>
                  <p className="text-sm text-white/80 mb-3">Full system access</p>
                  <code className="text-xs bg-card-black p-2 rounded block mb-1 text-primary-yellow">admin@demo.com</code>
                  <code className="text-xs bg-card-black p-2 rounded block text-primary-yellow">password123</code>
                </div>
              </div>
            </CardContent>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-2 mb-4">
              <div className="w-6 h-6 bg-primary-yellow rounded flex items-center justify-center">
                <span className="text-black font-bold text-xs">GSC</span>
              </div>
